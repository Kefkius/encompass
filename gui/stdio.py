...
_ = lambda x:x
#from i18n import _
from encompass.wallet import WalletStorage, Wallet
from encompass.util import format_satoshis, set_verbosity, StoreDict
from encompass.bitcoin import is_valid, COIN
from encompass.network import filter_protocol
