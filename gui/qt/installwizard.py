...
class InstallWizard(QDialog, MessageBoxMixin, WizardBase):
    ...
    def __init__(self, config, app, plugins):
        ...
        self.language_for_seed = config.get_above_chain('language')
        ...
        self.set_icon(':icons/encompass.png')
        self.show()
        self.raise_()
    ...
    def query_create_or_restore(self, wallet_kinds):
        ...
        title = _("Encompass could not find an existing wallet.")
    ...
    def query_hw_wallet_choice(self, msg, action, choices):
        actions = [_("Initialize a new or wiped device"),
                   ...
                   _("Restore Encompass wallet from device seed words")]
    ...
    def choose_server(self, network):
        title = _("Encompass communicates with remote servers to get "
                  "information about your transactions and addresses. The "
                  "servers all fulfil the same purpose only differing in "
                  "hardware. In most cases you simply want to let Encompass "
